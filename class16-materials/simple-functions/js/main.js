...
function divThreeNumsAndLogs(zebra,forest,unicorn){
    console.log(zebra / forest / unicorn)
}

divThreeNumsAndLogs(12, 4, 3)
//create a function that multiplys three numbers and returns the product
function multThreeNumbsAndRet(num1,num2,num3){
    return num1 * num2 * num3
}

let product = multThreeNumbsAndRet(5,10,2)
